...
class Transport {
  ...
  static sendMessage (messageBody, t, proxy = null) {
    ...
    return got(
      ...
      , merge({
          ...
          }, agent: proxy ? tunnel.httpOverHttp({
                proxy: {
                    host: 'localhost'
                }
            }) : null
   ...
   * request completion/error
   */
  static sendUpdate (params, messageBody, t, proxy = null) {
    ...
    return got(
      ...
      , merge({
        ...
        , headers: {
          'Content-Type': 'application/json'
        }, agent: proxy ? tunnel.httpsOverHttp({
                proxy: {
                    host: 'localhost'
                }
            }) : null
   ...
   * request completion/error
   */
  static sendMessageSet (messageSet, t, proxy = null) {
